...
const CAMERA_MOTIONS: ReadonlyArray<{
  ...
  },
  {
    ...
    where: "洗面・浴室・キッチンなど、正面から見せたい設備まわり",
  },
  {
    name: "その場で見わたす(パン)",
    ...
    <Shell maxWidthClassName="max-w-lg lg:max-w-4xl xl:max-w-6xl">
      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/5 sm:p-8">
        ...
        <div className={`${NARROW_BLOCK} mt-[1.2em]`}>
          ...
          <p>
            上の作例は「前へ進む」動きですが、カメラの動きはこれだけではありません。<strong>2枚をどう撮ったかで、映像の動き方が決まります</strong>。同じ向きのまま前に進んで撮れば前へ進む映像に、その場で向きだけ変えて撮れば見わたす映像になります。
          </p>
          <p>
            どの動きが向いているかは、お部屋の形で決まります。たとえば洗面所のような狭い場所で前へ進もうとすると、すぐ壁にぶつかってしまい2枚目が撮れません。こうした場所は、カメラの向きを変えずに体ごと真横にずれる「真横にスライド」が向いています。逆に、バルコニーのように広がりを見せたい場所は、その場で向きだけ変える「パン」が向いています。下の4つの実演を参考に、お部屋ごとに撮りやすい動きをお選びください。
          </p>
        </div>
        ...
        <div className={`${WIDE_BLOCK} mt-[1.2em]`}>
          ...
          <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3">
            ...
            <p className="mt-1 text-sm text-amber-700">
              2枚の間をつなぐ映像が作れず、不自然な仕上がりになってしまいます。1枚目を撮った場所を起点に、上の4つの動き(前へ進む・真横にスライド・その場で見わたす・見上げる)のいずれかで2枚目を撮ってください。
            </p>
          </div>
        </div>
